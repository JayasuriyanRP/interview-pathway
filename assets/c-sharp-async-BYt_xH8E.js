const e=[{id:"29539a01-47b4-474c-b20e-e4782ab0d1a4",question:"What is asynchronous programming in C#?",answer:`\`\`\`markdown
...
\`\`\``,level:"Beginner",created_at:"2025-03-28T18:08:48.838754Z",topic:"61191975-a398-43cd-9ea0-5dbba01918d3"},{id:"ab8b398e-dd1f-4d0d-a2d0-368026dbe37d",question:"What are the benefits of using asynchronous programming?",answer:`\`\`\`markdown
...
\`\`\``,level:"Beginner",created_at:"2025-03-28T18:08:48.838781Z",topic:"61191975-a398-43cd-9ea0-5dbba01918d3"},{id:"6ed4eaa7-e072-4f88-9852-2691878de1ed",question:"What is the difference between synchronous and asynchronous programming?",answer:`\`\`\`markdown
...
\`\`\``,level:"Intermediate",created_at:"2025-03-28T18:08:48.838945Z",topic:"61191975-a398-43cd-9ea0-5dbba01918d3"},{id:"13c5375c-0384-4dcf-8d58-6bd9e57b13d3",question:"How does the thread pool work in C# asynchronous programming?",answer:`\`\`\`markdown
...
\`\`\``,level:"Intermediate",created_at:"2025-03-28T18:08:48.838992Z",topic:"61191975-a398-43cd-9ea0-5dbba01918d3"},{id:"1cc522c4-2b0c-4486-ac8a-96732a9c7f97",question:"What is the purpose of the CancellationToken in asynchronous programming?",answer:`\`\`\`markdown
...
\`\`\``,level:"Intermediate",created_at:"2025-03-28T18:08:48.839001Z",topic:"61191975-a398-43cd-9ea0-5dbba01918d3"},{id:"f40c7eb1-c719-476b-98c6-e66a87d02be5",question:"How do you implement cancellation in an asynchronous method?",answer:`\`\`\`markdown
...
\`\`\``,level:"Intermediate",created_at:"2025-03-28T18:08:48.839011Z",topic:"61191975-a398-43cd-9ea0-5dbba01918d3"},{id:"bba8a739-c018-4121-b509-56417d2ce506",question:"What is the difference between a hot task and a cold task in C#?",answer:`\`\`\`markdown
...
\`\`\``,level:"Advanced",created_at:"2025-03-28T18:08:48.839021Z",topic:"61191975-a398-43cd-9ea0-5dbba01918d3"},{id:"cf92c7f2-6358-4db0-90bf-c1ca4baea8c8",question:"What are async streams, and how do you use them in C#?",answer:`\`\`\`markdown
### Async Streams in C#
...
\`\`\``,level:"Intermediate",created_at:"2025-03-28T18:08:48.839030Z",topic:"61191975-a398-43cd-9ea0-5dbba01918d3"},{id:"199505c1-e78f-42c5-aae1-36dd0c23863e",question:"What is the purpose of the IAsyncEnumerable<T> interface in C#?",answer:`\`\`\`markdown
...
\`\`\``,level:"Intermediate",created_at:"2025-03-28T18:08:48.839039Z",topic:"61191975-a398-43cd-9ea0-5dbba01918d3"},{id:"456e4106-de03-4abf-ab99-c9652c706a65",question:"How do you use the 'await foreach' loop with async streams?",answer:`\`\`\`markdown
...
\`\`\``,level:"Intermediate",created_at:"2025-03-28T18:08:48.839062Z",topic:"61191975-a398-43cd-9ea0-5dbba01918d3"},{id:"d0b05e20-a0e6-4449-a6a5-3a4f1a0b3fde",question:"What is the difference between async and parallel programming in C#?",answer:`\`\`\`markdown
...
\`\`\``,level:"Advanced",created_at:"2025-03-28T18:08:48.839090Z",topic:"61191975-a398-43cd-9ea0-5dbba01918d3"},{id:"6d4120ba-c1d9-42c9-a1bd-1edc9be6f8c6",question:"How do you test asynchronous methods in unit tests?",answer:`\`\`\`markdown
...
\`\`\``,level:"Intermediate",created_at:"2025-03-28T18:08:48.839100Z",topic:"61191975-a398-43cd-9ea0-5dbba01918d3"},{id:"d1e2b305-78c9-4d25-b6b6-3aa52b3e58af",question:"What is the purpose of the AsyncLocal<T> class in C#?",answer:`\`\`\`markdown
...
\`\`\``,level:"Intermediate",created_at:"2025-03-28T18:08:48.839138Z",topic:"61191975-a398-43cd-9ea0-5dbba01918d3"},{id:"ab78607b-4648-4085-a210-578ab2c7dd97",question:"How do you handle progress reporting in asynchronous methods?",answer:`\`\`\`markdown
...
\`\`\``,level:"Intermediate",created_at:"2025-03-28T18:08:48.839147Z",topic:"61191975-a398-43cd-9ea0-5dbba01918d3"},{id:"37f46fb6-c807-462b-9f9e-6d85b6895bea",question:"What is the purpose of the Task.Yield method in C#?",answer:`\`\`\`markdown
...
\`\`\``,level:"Advanced",created_at:"2025-03-28T18:08:48.839156Z",topic:"61191975-a398-43cd-9ea0-5dbba01918d3"},{id:"b936cfd5-68d9-4e92-b8a6-fd3567d466ab",question:"How does the compiler transform async methods into state machines?",answer:`\`\`\`markdown In C#, when you write an \`async\` method, the compiler transforms it into a state machine to handle asynchronous execution. Here's how the transformation works:
...
\`\`\``,level:"Advanced",created_at:"2025-03-28T18:08:48.839202Z",topic:"61191975-a398-43cd-9ea0-5dbba01918d3"},{id:"efd8bbe2-78b6-4f01-8341-f31ad5dcf580",question:"How do you use the SemaphoreSlim class in asynchronous programming?",answer:`\`\`\`markdown
...
\`\`\``,level:"Intermediate",created_at:"2025-03-28T18:08:48.839238Z",topic:"61191975-a398-43cd-9ea0-5dbba01918d3"},{id:"0bd45a0c-4b6c-4c65-8820-9e4c6deeff59",question:"How do you implement a custom awaiter in C#?",answer:`\`\`\`markdown To implement a custom awaiter in C#, you need to create a class that implements the \`INotifyCompletion\` interface and provides the required methods and properties to support the \`await\` keyword. Below is an example of how to implement a custom awaiter:
...
This example demonstrates how to create a custom awaiter that introduces a delay, but you can adapt the logic to suit other asynchronous operations.`,level:"Advanced",created_at:"2025-03-28T18:08:48.839248Z",topic:"61191975-a398-43cd-9ea0-5dbba01918d3"},{id:"dee8d0bb-77a7-498c-adb8-8c6589b01d57",question:"What is the purpose of the FromResult method in the Task class?",answer:`\`\`\`markdown
...
\`\`\``,level:"Intermediate",created_at:"2025-03-28T18:08:48.839262Z",topic:"61191975-a398-43cd-9ea0-5dbba01918d3"},{id:"a4cd080e-8014-452b-a1ab-5f5ec6a7168d",question:"How do you create a fire-and-forget asynchronous method?",answer:`\`\`\`markdown
